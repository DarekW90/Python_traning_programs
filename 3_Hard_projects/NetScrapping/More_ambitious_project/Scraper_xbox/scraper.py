...
class GameScraper:
    ...
    def scrape_page(self):
        ...
        url = f'https://www.ultima.pl/ct/xbox-series-x/gry/?page={self.page}'
        ...
        for product in products[3:]:
            ...
            if 'XONE' in product_name or 'XSX' in product_name:
                product_name = product_name.replace('XONE', '').replace('XSX', '')
    ...
    def run(self):
        while self.page < 30:  # Change this condition if needed
        ...
        csv_path = os.path.join(data_directory, 'xbox_data.csv')
